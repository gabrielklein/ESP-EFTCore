...
ESPFishTank is an open source aquarium / fish tank controller for the ESP8266 NodeMCU.

The ideal companion for your aquariums.

Features of this project

* You can get the temperature of the water.
* You can get the temperature and humidity of the room around the aquarium.
* You can switch on and off the lights
* You can switch on and off a heater
* You get view alerts on a rgb led.

And you have the following  interfaces

* You can control your lights and a heater using a web interface.
* You can view informations and control your aquarium using MQTT.
* You have a small rest API (if you want to connect a phone application :) ).

# What do you need

* An ESP8266 controller, NodeMCU v2
* DS18B20 Waterproof temperature sensors
* Two Relay Module (One for the heater and one for the light)
* DHT22 temperature and humidity sensor
* One RGB led

And some skills in electronics :)
...
- PlatformIO
- An DS18B20 Waterproof temperature sensors
- Some modules
